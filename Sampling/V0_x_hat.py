...
batch_size, num_samples, dim = 500, 1, 2
...
for i, t in enumerate(tt):
    ...
    u, x_hat = compute_control(x0, y, y_star, H_inv, beta, t, energy_function)
    ...
    if i % 10 == 0: 
       ...
       plt.plot(x_hat[:,0].cpu().numpy(), x_hat[:,1].cpu().numpy(), 'o', color='green')
